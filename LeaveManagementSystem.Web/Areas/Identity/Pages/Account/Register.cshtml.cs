    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            var roles = await _roleManager.Roles
                .Select(q => q.Name)
                .Where(q => q != "Administrator") // Exclude Administrator role from registration
                .ToArrayAsync();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Load the email template from the web root path
                    // Note: _hostEnvironment.WebRootPath gives the path to the wwwroot folder
            ...
            // NOTE! We need to re-populate the roles for the dropdown list, since the page is being redisplayed
            var roles = await _roleManager.Roles
                .Select(q => q.Name)
                .Where(q => q != "Administrator") // Exclude Administrator role from registration
                .ToArrayAsync();
